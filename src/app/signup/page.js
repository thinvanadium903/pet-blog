            ...
            <div className="signup-container">
                ...
                <form onSubmit={handleSignUp}>
                    <div className="warnings">
                        ...
                        <p className={validName() ? "valid-entry" : hasInteracted.name ? "invalid-entry" : ""}>
                            Name must be non-empty{validName() ? <span>✅</span> : hasInteracted.name && <span>❌</span>}
                        </p>
                        ...
                        <p className={validEmail() ? "valid-entry" : hasInteracted.email ? "invalid-entry" : ""}>
                            Must use a valid email{validEmail() ? <span>✅</span> : hasInteracted.email &&
                            <span>❌</span>}
                        </p>
                        ...
                        <p className={validPassword() ? "valid-entry" : hasInteracted.password ? "invalid-entry" : ""}>
                            Password must be at least <br/> 6 characters{validPassword() ?
                            <span>✅</span> : hasInteracted.password && <span>❌</span>}
                        </p>
                    </div>
                    <button
                        type="submit"
